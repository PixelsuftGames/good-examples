...
class Scene(scene.Scene):
    ...
    def update(self, dt: float) -> None:
        ...
        self.r.blit(self.tex1, dst_rect=(500, 50))
        self.r.blit(self.tex2, dst_rect=(50, 50))
        self.r.blit(self.tex3, dst_rect=(50, 150))
        self.r.blit(self.tex4, dst_rect=(50, 250))
        self.r.blit(self.tex5, dst_rect=(200, 230))
        self.r.blit(self.tex6, dst_rect=(100, 300))
        self.r.blit(self.tex7, dst_rect=(200, 300))
        self.r.blit(self.tex8, dst_rect=(150, 320))
        self.r.blit(self.tex9, dst_rect=(150, 400))
        self.r.blit(self.tex10, dst_rect=(150, 450))
        for angle in range(0, 360, 45):
            self.r.blit_ex(self.tex11, dst_rect=(700, 300), angle=angle + self.spin1.value, center=(0, 0))
        for angle in range(15, 375, 30):
            self.r.blit_ex(self.tex12, dst_rect=(500, 550), angle=angle + self.spin2.value, center=(0, 0))
